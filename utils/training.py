...
from compute_q.compute_Q_pytorch import compute_Q_msssim as compute_Q
...
q_vecs_4 = q_vecs_4.transpose(3, 0, 1, 2)
...
q_vecs_8 = q_vecs_8.transpose(3, 0, 1, 2)
...
q_vecs_16 = q_vecs_16.transpose(3, 0, 1, 2)
