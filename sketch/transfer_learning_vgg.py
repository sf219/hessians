...
torch.save(model_ft, 'sketch/models/trained_insects_alex.pth')
...
torch.save(model_conv, 'sketch/models/transfer_insects_alex.pth')
...
visualize_model_predictions(
    model_conv,
    img_path='Images/hymenoptera_data/val/bees/72100438_73de9f17af.jpg'
)
