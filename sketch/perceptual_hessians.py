...
compute_Q_obj_ssim = compute_Q_ssim(true_N=true_N)
compute_Q_obj_msssim = compute_Q_msssim(true_N=true_N)
compute_Q_obj_brisque = compute_Q_brisque(true_N=true_N)
compute_Q_obj_lpips = compute_Q_lpips(true_N=true_N)
...
for img_name in dirs:
    ...
    Q_ssim = compute_Q_obj_ssim.sample_q_ip_gaussian(img)
    Q_msssim = compute_Q_obj_msssim.sample_q_ip_gaussian(img)
    Q_brisque = compute_Q_obj_brisque.sample_q_ip_gaussian(img)
    Q_lpips = compute_Q_obj_lpips.sample_q_ip_gaussian(img)
