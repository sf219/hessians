...
compute_Q_obj = compute_Q_class(true_N=true_N, sampling_depth=64)
...
for i in range(num_images):
    ...
    plt.yticks([])
    plt.tight_layout()
    str_out = 'sketch/real_tmps/{}_brisque_maps.pdf'.format(i)
    ...
    # set axis tight
    plt.tight_layout()
    str_out = 'sketch/real_tmps/{}_brisque_rd.pdf'.format(i)
    plt.savefig(str_out, bbox_inches='tight')    
    #plt.show()
